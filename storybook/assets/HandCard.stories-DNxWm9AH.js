import{i as e}from"./preload-helper-BdFrVu1K.js";import{a as t,c as n,t as r,u as i}from"./Card-CIXpfrUA.js";import{r as a,t as o}from"./stories.common-B0_Wn-EV.js";import{n as s,t as c}from"./HandCard-DPX21Ra0.js";var l,u,d,f,p,m,h,g,_,v;e((()=>{i(),a(),s(),l={argTypes:o(`rank`,t),component:c,parameters:{layout:`centered`},tags:[`autodocs`],title:`HandCard`},u=({dealOrderIndex:e,kept:t,rank:n,suit:r})=>({args:{dealOrderIndex:e,kept:t,onChange:()=>null,rank:n,suit:r}}),d={FIFTH:4,FIRST:0,FOURTH:3,SECOND:1,SIXTH:5,THIRD:2},f=u({dealOrderIndex:d.FIRST,kept:!1,rank:r.ACE.rank,suit:n.HEARTS}),p=u({dealOrderIndex:d.SECOND,kept:!0,rank:r.FIVE.rank,suit:n.DIAMONDS}),m=u({dealOrderIndex:d.THIRD,kept:!0,rank:r.NINE.rank,suit:n.CLUBS}),h=u({dealOrderIndex:d.FOURTH,kept:!0,rank:r.TEN.rank,suit:n.SPADES}),g=u({dealOrderIndex:d.FIFTH,kept:!0,rank:r.JACK.rank,suit:n.HEARTS}),_=u({dealOrderIndex:d.SIXTH,kept:!1,rank:r.KING.rank,suit:n.DIAMONDS}),f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`createStory({
