import{i as e}from"./preload-helper-BdFrVu1K.js";import{t,u as n}from"./Card-CIXpfrUA.js";import{i as r,t as i}from"./SortOrderName-MXRr2nWr.js";import{c as a,i as o,l as s,o as c,r as l,t as u}from"./stories.common-B0_Wn-EV.js";import{o as d,t as f}from"./expectedCribPoints-vR0MW9Bt.js";import{a as p,c as m,i as h,l as g,n as _,o as v,r as y,s as b,t as x}from"./ScoredPossibleKeepDiscards-Bu9-mSzw.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{b(),p(),l(),n(),d(),h(),_(),{expect:S,fireEvent:C,fn:w,within:T}=__STORYBOOK_MODULE_TEST__,E=!1,D=()=>E?(E=!1,Promise.reject(Error(`Fake load error`))):m(),O={argTypes:u(`sortOrder`,i),component:x,parameters:{layout:`centered`},tags:[`autodocs`],title:`ScoredPossibleKeepDiscards`},k=(e,t)=>({args:{cribRole:f.Dealer,dealtCards:e,onAnalysisRendered:w(),onScoreSortKeyChange:w(),scoreSortKey:y.ExpectedNetPoints,sortOrder:t}}),A=a([t.JACK,t.SIX,t.FIVE,t.FOUR,t.KING,t.QUEEN],[0,1]),j=k(A,r.Descending),M={...k(A,r.Ascending),args:{...k(A,r.Ascending).args,cribRole:f.Pone}},N=k(A,r.DealOrder),P={...j,play:c},F={...P,play:o},I={...F,args:{...F.args,cribRole:f.Pone}},L={...j,args:{...j.args,scoreSortKey:y.ExpectedHandPoints},play:async({canvasElement:e})=>{let t=T(e);await s(t);let n=await t.findByRole(`columnheader`,{name:/Hand/u});await S(n).toHaveAttribute(`aria-sort`,`descending`)}},R={...j,args:{...j.args,loadCribTable:D},loaders:[()=>{E=!0,g(null),v(null)}],play:async({canvasElement:e})=>{let t=T(e),n=await t.findByRole(`button`,{name:/Retry/u});await S(n).toBeVisible(),await C.click(n),await s(t)}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`createStory(dealtCards, SortOrder.Descending)`,...j.parameters?.docs?.source}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
