import{i as e}from"./preload-helper-BdFrVu1K.js";import{a as t,d as n}from"./CardLabel-DOrztDns.js";import{a as r,i}from"./SortOrderName-MXRr2nWr.js";import{i as a,s as o}from"./stories.common-Ch_UTuRa.js";import{o as s,t as c}from"./expectedCribPoints-BOulACVp.js";import{n as l,t as u}from"./EnterCardsDialog-Cu4o7TbJ.js";var d,f,p,m,h,g,_,v,y,b;e((()=>{s(),n(),l(),r(),a(),{expect:d,fn:f,userEvent:p,within:m}=__STORYBOOK_MODULE_TEST__,h={args:{initialCards:t.slice(0,6),initialCribRole:c.Dealer,onClose:f(),onSubmit:f(),show:!0,sortOrder:i.Descending},component:u,tags:[`autodocs`],title:`EnterCardsDialog`},g={},_={play:async({canvasElement:e})=>{let t=m(e);await p.click(t.getByRole(`button`,{name:`Clear`})),await d(t.getByText(`0 of 6`)).toBeInTheDocument(),await d(t.getByRole(`button`,{name:`Clear`})).toBeDisabled(),await d(t.getByRole(`button`,{name:`Use hand`})).toBeDisabled()}},v={play:async({args:e,canvasElement:n})=>{let r=m(n),i=r.getByRole(`button`,{name:`A♣`,pressed:!0});await p.click(i),await d(i).toHaveAttribute(`aria-pressed`,`false`),await p.click(r.getByRole(`button`,{name:`7♣`})),await p.click(r.getByRole(`radio`,{name:`Pone`})),await p.click(r.getByRole(`button`,{name:`Use hand`})),await d(e.onSubmit).toHaveBeenCalledWith([...t.slice(1,6),t[6]],c.Pone)}},y={play:o},g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{}`,...g.parameters?.docs?.source}}},_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
