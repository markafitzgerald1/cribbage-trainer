import{i as e}from"./preload-helper-BdFrVu1K.js";import{f as t,r as n}from"./CardLabel-DzMnb-K4.js";import{i as r,t as i}from"./SortOrderName-MXRr2nWr.js";import{a,c as o,d as s,i as c,n as l,u}from"./stories.common-Ch_UTuRa.js";import{o as d,t as f}from"./expectedCribPoints-DXsu9hVf.js";import{a as p,c as m,i as h,l as g,n as _,o as v,r as y,s as b,t as x}from"./ScoredPossibleKeepDiscards-C57FDNjc.js";var S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z;e((()=>{b(),p(),c(),t(),d(),h(),_(),{expect:S,fireEvent:C,fn:w,within:T}=__STORYBOOK_MODULE_TEST__,E=!1,D=()=>E?(E=!1,Promise.reject(Error(`Fake load error`))):m(),O={argTypes:l(`sortOrder`,i),component:x,parameters:{layout:`centered`},tags:[`autodocs`],title:`ScoredPossibleKeepDiscards`},k=(e,t)=>({args:{cribRole:f.Dealer,dealtCards:e,onAnalysisRendered:w(),onScoreSortKeyChange:w(),scoreSortKey:y.ExpectedNetPoints,sortOrder:t}}),A=u([n.JACK,n.SIX,n.FIVE,n.FOUR,n.KING,n.QUEEN],[0,1]),j=k(A,r.Descending),M={...k(A,r.Ascending),args:{...k(A,r.Ascending).args,cribRole:f.Pone}},N=k(A,r.DealOrder),P={...j,play:o},F={...P,play:a},I={...F,args:{...F.args,cribRole:f.Pone}},L={...j,args:{...j.args,scoreSortKey:y.ExpectedHandPoints},play:async({canvasElement:e})=>{let t=T(e);await s(t);let n=await t.findByRole(`columnheader`,{name:/Hand/u});await S(n).toHaveAttribute(`aria-sort`,`descending`)}},R={...j,args:{...j.args,loadCribTable:D},loaders:[()=>{E=!0,g(null),v(null)}],play:async({canvasElement:e})=>{let t=T(e),n=await t.findByRole(`button`,{name:/Retry/u});await S(n).toBeVisible(),await C.click(n),await s(t)}},j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`createStory(dealtCards, SortOrder.Descending)`,...j.parameters?.docs?.source}}},M.parameters={...M.parameters,docs:{...M.parameters?.docs,source:{originalSource:`{
