import{i as e}from"./preload-helper-BdFrVu1K.js";import{f as t,r as n,s as r,u as i}from"./CardLabel-DzMnb-K4.js";import{i as a,n as o}from"./stories.common-Ch_UTuRa.js";import{n as s,t as c}from"./HandCard-CqgOz7Uh.js";var l,u,d,f,p,m,h,g,_,v;e((()=>{t(),a(),s(),l={argTypes:o(`rank`,r),component:c,parameters:{layout:`centered`},tags:[`autodocs`],title:`HandCard`},u=({dealOrderIndex:e,kept:t,rank:n,suit:r})=>({args:{dealOrderIndex:e,kept:t,onChange:()=>null,rank:n,suit:r}}),d={FIFTH:4,FIRST:0,FOURTH:3,SECOND:1,SIXTH:5,THIRD:2},f=u({dealOrderIndex:d.FIRST,kept:!1,rank:n.ACE.rank,suit:i.HEARTS}),p=u({dealOrderIndex:d.SECOND,kept:!0,rank:n.FIVE.rank,suit:i.DIAMONDS}),m=u({dealOrderIndex:d.THIRD,kept:!0,rank:n.NINE.rank,suit:i.CLUBS}),h=u({dealOrderIndex:d.FOURTH,kept:!0,rank:n.TEN.rank,suit:i.SPADES}),g=u({dealOrderIndex:d.FIFTH,kept:!0,rank:n.JACK.rank,suit:i.HEARTS}),_=u({dealOrderIndex:d.SIXTH,kept:!1,rank:n.KING.rank,suit:i.DIAMONDS}),f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`createStory({
