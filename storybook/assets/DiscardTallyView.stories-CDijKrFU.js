import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{n as t,t as n}from"./DiscardTallyView-YQOBfmGf.js";import{a as r,i}from"./MistakeQueueDialog.test.common-B99XRCtq.js";var a;function o(){return(o=e((()=>{a=(e={})=>({decisions:24,meanExpectedPointsLoss:.7361,optimalDecisions:9,skippedHands:0,todayDecisions:0,todayMeanExpectedPointsLoss:null,todayOptimalDecisions:0,todaySkippedHands:0,...e})})))()}var s,c,l,u,d,f,p,m,h,g,_,v,y;function b(){return(b=e((()=>{t(),r(),o(),{expect:s,userEvent:c}=__STORYBOOK_MODULE_TEST__,l=i(),u={component:n,parameters:{layout:`centered`},tags:[`autodocs`],title:`DiscardTallyView`},d=(e,t)=>({args:{summary:e},play:async({canvas:e})=>{await s(e.getByText(t)).toBeVisible()}}),f=d(a({todayDecisions:5,todayMeanExpectedPointsLoss:.4128,todayOptimalDecisions:2}),`0.41`),p=d(a({decisions:3,meanExpectedPointsLoss:0,optimalDecisions:3}),`0.00`),m=d(a({skippedHands:7,todayDecisions:5,todayMeanExpectedPointsLoss:.4128,todayOptimalDecisions:2,todaySkippedHands:3}),`Hands skipped`),h={args:{summary:a({decisions:0,meanExpectedPointsLoss:null,optimalDecisions:0})},play:async({canvasElement:e})=>{await s(e.textContent).toBe(``)}},g=a({decisions:10,meanExpectedPointsLoss:.25,optimalDecisions:7}),_={args:{summary:g},play:async({canvas:e})=>{let t=e.getByRole(`button`,{name:`Quality trend`});await s(t).toBeVisible(),await c.click(t),await s(e.getByText(`Decision quality over time`)).toBeVisible()}},v={args:{summary:g,tally:l},play:async({canvas:e})=>{let t=e.getByRole(`button`,{name:`Mistake queue`});await s(t).toBeVisible(),await c.click(t),await s(e.getByRole(`heading`,{name:`Mistake queue`})).toBeVisible()}},y=[`Default`,`FaultlessSoFar`,`WithSkippedHands`,`NothingFacedYet`,`OpenQualityTrend`,`OpenMistakeQueue`],f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`showing(discardTallySummary({
  todayDecisions: 5,
...
}`,...v.parameters?.docs?.source}}}})))()}b();export{f as Default,p as FaultlessSoFar,h as NothingFacedYet,v as OpenMistakeQueue,_ as OpenQualityTrend,m as WithSkippedHands,y as __namedExportsOrder,u as default};