...
export const decisionDetailActions: string;
...
export const decisionDetailMastered: string;
export const decisionDetailPractice: string;
...
export const lossDotMastered: string;
...
export const lossStemMastered: string;
