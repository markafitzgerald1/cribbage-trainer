...
import { spellcheckSkipWords } from "./eslintSpellcheckSkipWords.mjs";
      ...
      "jest/expect-expect": [
        "error",
        {
          assertFunctionNames: [
            ...
            "expectLastAnalysisShown",
            "expectSecondAnalysisInformed",
            "expectHistoryMove",
            ...
            "expectNoticeClearsAfterWindow",
            "expectNoticeShown",
            "expectNoticeStillShown",
            "expectPanelText",
            "expectNoPanel",
            "expectChartRendered",
            "expectNoConsecutiveRepeats",
            "expectNoConsecutiveRepeatsPerSuit",
          ],
        },
      ],
