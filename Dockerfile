...
COPY .github/ .github/
COPY .cspell.json .gitignore .jscpd.json .markdownlint.json .markdownlintignore .nsprc .prettierignore .prettierrc.json .stylelintignore .stylelintrc.json babel.config.json eslint.config.mjs jest.config.json package.json package-lock.json styles.d.ts tsconfig.json vite.config.mjs ./
COPY *.md ./
COPY skills/ ./skills/
COPY src/ ./src/
